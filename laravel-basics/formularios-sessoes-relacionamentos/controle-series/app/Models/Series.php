...
// att: trocando de: Serie para Series, pois em inglês Série == Series
class Series extends Model
{
    ...
    // att: trocado nome do método de relacionamento de: temporadas para: seasons, para padronizar o inglês na aplicaćão e não ficar misturando pt_br e en_Us
